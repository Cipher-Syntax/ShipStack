...
const DeveloperSalesPage = () => {
    ...
    return (
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 animate-in fade-in duration-300 font-sans">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-text-secondary text-sm mt-1">
                        Track your revenue, inspect transactions, and manage buyer relationships.
                    </p>
                </div>
            ...
            {error && (
                <div className="bg-red-50 dark:bg-red-950/40 text-red-600 dark:text-red-400 p-4 rounded-2xl mb-8 border border-red-200 dark:border-red-900/50 text-sm font-medium">
                    {error}
                </div>
            )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-background-secondary p-6 rounded-2xl border border-border-primary shadow-sm relative overflow-hidden group hover:border-emerald-500/50 transition-colors">
                    <div className="flex items-center justify-between mb-3">
                        <span className="text-xs font-bold text-text-secondary uppercase tracking-wider">Gross Earnings</span>
